...
class ForoEmprendedoresParticipantesController extends Controller
{
    ...
    public function index (){
        return view('dashboard.registrosForoEmprendedores');
    }
    ...
    public function registroParticipante(Request $request){
        ...
        $participante = ForoEmprendedoresParticipantes::create($validator->validate());
    ...
    public function all (){
        return ForoEmprendedoresParticipantes::where("año",2025)->get();
    }
    public function numeroDeRegistros (){
        return count(ForoEmprendedoresParticipantes::where("año",2025)->get()->toArray());
    }
    public function obtenerCSVRegistrados(){
        $registros = ForoEmprendedoresParticipantes::where("año",2025)->get();

        // these are the headers for the csv file.
        $headers = array(
            'Content-Type' => 'application/vnd.ms-excel; charset=utf-8',
            'Cache-Control' => 'must-revalidate, post-check=0, pre-check=0',
            'Content-Disposition' => 'attachment; filename=foro-personas-registradas.csv',
            'Expires' => '0',
            'Pragma' => 'public',
        );
        ...
        $filename =  public_path("files/foro-personas-registradas.csv");
        ...
        //download command
        return Response::download($filename, "foro-personas-registradas.csv", $headers);
    }
}
